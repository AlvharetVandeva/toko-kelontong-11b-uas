...
export default async function Beranda() {
  ...
  const categories = [
    { id: 1, name: "Sembako", icon: "🍚", url: "/katalog?kategori=sembako" },
    { id: 2, name: "Makanan Ringan", icon: "🍿", url: "/katalog?kategori=makanan-ringan" },
    { id: 3, name: "Minuman", icon: "🥤", url: "/katalog?kategori=minuman" },
    { id: 4, name: "Peralatan Mandi", icon: "🧼", url: "/katalog?kategori=peralatan-mandi" },
    { id: 5, name: "Bumbu Dapur", icon: "🧂", url: "/katalog?kategori=bumbu-dapur" },
    { id: 6, name: "Alat Tulis", icon: "✏️", url: "/katalog?kategori=alat-tulis" }
  ];
